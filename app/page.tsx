  ...
  return (
    <main className="flex flex-col h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <header className="flex fixed top-0 justify-between text-white w-full p-5">
        <SettingsIcon
          className="p-2 m-2 rounded-full cursor-pointer bg-gradient-to-b from-gray-900 to-black text-white"
      ...
      <form action={formAction} className="flex flex-col bg-black">
        <div className="flex-1 bg-gradient-to-b  from-gray-900 to-black text-white">
